...
> 性质：背景设计材料。自 2026-08-29 起，正式目标、范围、阶段、验证与准入事实源为 [ECS 动态 SSH 公网 IP 同步专项计划](plans/ecs-dynamic-ssh-ip.md)。本文保留最初的方案推导；与专项计划冲突时以专项计划为准，且不代表已经修改 ECS、安全组或 TunnelPad 代码。
