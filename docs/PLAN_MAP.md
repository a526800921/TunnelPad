...
|---|---|---|---|---|---|
| [TunnelPad 无人值守 SSH 异常恢复与孤儿清理](plans/tunnelpad-unattended-ssh-recovery-and-orphan-cleanup.md) | 实施中 | 阶段 1 | 2026-09-19 | tunnelpad-unattended-launch-recovery, tunnelpad-unattended-managed-ssh-recovery, tunnelpad-log-write-amplification | [专项计划](plans/tunnelpad-unattended-ssh-recovery-and-orphan-cleanup.md)；[阶段 0 Step 0](data-quality/tunnelpad-unattended-ssh-recovery-stage0-step0-20260915.md)；[远端清理增量 Step 0](data-quality/tunnelpad-unattended-remote-forward-cleanup-step0-20260919.md)；[远端清理独立复核](reviews/tunnelpad-unattended-remote-forward-cleanup-independent-review-20260919.md)；[远端清理修复自验](data-quality/tunnelpad-unattended-remote-forward-cleanup-remediation-20260919.md)；[合并独立复核](reviews/tunnelpad-unattended-stage1-consolidated-review-20260919.md)；[阶段 1 修复自验证据](data-quality/tunnelpad-unattended-stage1-review-remediation-20260919.md)；[运行期退避修复证据](data-quality/tunnelpad-unattended-runtime-backoff-remediation-20260919.md)；阶段 1 代码阻塞解除，待阶段 2 长时与用户验收 |
| [TunnelPad 无人值守 ECS 公网 IP 漂移同步与断线恢复](plans/tunnelpad-unattended-ecs-ip-drift-recovery.md) | 实施中 | 阶段 1 | 2026-09-19 | ecs-dynamic-ssh-ip, tunnelpad-launch-autostart, tunnelpad-unattended-ssh-recovery-and-orphan-cleanup | [专项计划](plans/tunnelpad-unattended-ecs-ip-drift-recovery.md)；[合并独立复核](reviews/tunnelpad-unattended-stage1-consolidated-review-20260919.md)首轮发现与补充只读核对；[阶段 1 修复自验证据](data-quality/tunnelpad-unattended-stage1-review-remediation-20260919.md)覆盖持续恢复契约及 D10–D12；[运行期退避修复证据](data-quality/tunnelpad-unattended-runtime-backoff-remediation-20260919.md)固定 `0/5/10/30/60` 秒契约；阶段 1 代码门禁通过，待阶段 2 长时验收 |
...
| 阶段 2 真实无人值守证据 | 补充多隧道共享 ECS、pending journal、错误规则属性、延迟/忽略 `SIGTERM`、真实 `18080` 冲突和长时漂移样本；这是后续阶段门禁，不阻塞当前阶段 1 | [TunnelPad 无人值守 ECS 公网 IP 漂移同步与断线恢复](plans/tunnelpad-unattended-ecs-ip-drift-recovery.md) | 否 | 待阶段 2 |
