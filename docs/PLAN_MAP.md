...
| 计划 | 状态 | 当前阶段 | 最后更新 | 依赖 | 证据 |
|---|---|---|---|---|---|
| [TunnelPad 无人值守 SSH 异常恢复与孤儿清理](plans/tunnelpad-unattended-ssh-recovery-and-orphan-cleanup.md) | 已完成 | - | 2026-09-19 | tunnelpad-unattended-launch-recovery, tunnelpad-unattended-managed-ssh-recovery, tunnelpad-log-write-amplification | [专项计划](plans/tunnelpad-unattended-ssh-recovery-and-orphan-cleanup.md)；[远端清理独立复核](reviews/tunnelpad-unattended-remote-forward-cleanup-independent-review-20260919.md)；[修复自验](data-quality/tunnelpad-unattended-remote-forward-cleanup-remediation-20260919.md)；[真实 IP 切换与用户验收](data-quality/tunnelpad-unattended-final-acceptance-20260919.md) |
| [TunnelPad 无人值守 ECS 公网 IP 漂移同步与断线恢复](plans/tunnelpad-unattended-ecs-ip-drift-recovery.md) | 已完成 | - | 2026-09-19 | ecs-dynamic-ssh-ip, tunnelpad-launch-autostart, tunnelpad-unattended-ssh-recovery-and-orphan-cleanup | [专项计划](plans/tunnelpad-unattended-ecs-ip-drift-recovery.md)；[合并独立复核](reviews/tunnelpad-unattended-stage1-consolidated-review-20260919.md)；[阶段 1 修复自验](data-quality/tunnelpad-unattended-stage1-review-remediation-20260919.md)；[运行期退避修复](data-quality/tunnelpad-unattended-runtime-backoff-remediation-20260919.md)；[真实 IP 切换与用户验收](data-quality/tunnelpad-unattended-final-acceptance-20260919.md) |
...
|---|---|---|---|---|
| 端到端恢复与云端同步 P1 | [合并独立复核](reviews/tunnelpad-unattended-stage1-consolidated-review-20260919.md)首轮发现运行期共享 ECS 结果、配置事务和重复退出缺口；[整改证据](data-quality/tunnelpad-unattended-stage1-review-remediation-20260919.md)及同一复核者增量复验均已通过 | [TunnelPad 无人值守 ECS 公网 IP 漂移同步与断线恢复](plans/tunnelpad-unattended-ecs-ip-drift-recovery.md) | 否 | 已完成 |
| 受管身份和代理进程回收 P1 | [端到端评审 R7–R10/R13](reviews/tunnelpad-unattended-end-to-end-review-20260919.md)与[合并独立复核](reviews/tunnelpad-unattended-stage1-consolidated-review-20260919.md)的生命周期缺口均已按[整改证据](data-quality/tunnelpad-unattended-stage1-review-remediation-20260919.md)闭合，并通过同轮增量复验 | [TunnelPad 无人值守 SSH 异常恢复与孤儿清理](plans/tunnelpad-unattended-ssh-recovery-and-orphan-cleanup.md) | 否 | 已完成 |
| 远端 `18080` 排他端口强杀 | 唯一[独立设计复核](reviews/tunnelpad-unattended-remote-forward-cleanup-independent-review-20260919.md)的 5 项 P1 已按[修复自验](data-quality/tunnelpad-unattended-remote-forward-cleanup-remediation-20260919.md)闭环；`motorcycle` 单独开启，默认关闭、pidfd、远端单动作、SSH 边界、真实 ECS 隔离端口和新 App 启动均通过 | [TunnelPad 无人值守 SSH 异常恢复与孤儿清理](plans/tunnelpad-unattended-ssh-recovery-and-orphan-cleanup.md) | 否 | 已完成 |
| 阶段 2 真实无人值守证据 | [最终验收](data-quality/tunnelpad-unattended-final-acceptance-20260919.md)已通过真实 IP 切换验证 `/32` 同步、旧实例清理、`18080` 单监听、SSH 自动恢复和无重试风暴；用户明确同意收口，长期观察转为常规运行监测 | [TunnelPad 无人值守 ECS 公网 IP 漂移同步与断线恢复](plans/tunnelpad-unattended-ecs-ip-drift-recovery.md)；[TunnelPad 无人值守 SSH 异常恢复与孤儿清理](plans/tunnelpad-unattended-ssh-recovery-and-orphan-cleanup.md) | 否 | 已完成 |
...
| 计划 | 阶段 | 证据 |
|---|---|---|
| tunnelpad-unattended-ssh-recovery-and-orphan-cleanup | 阶段 0–2 | [最终验收](data-quality/tunnelpad-unattended-final-acceptance-20260919.md)（真实 IP 切换后约 23 秒自动恢复，旧本机/远端进程消失，`18080` 单监听，无人工点击；用户已验收） |
| tunnelpad-unattended-ecs-ip-drift-recovery | 阶段 0–2 | [最终验收](data-quality/tunnelpad-unattended-final-acceptance-20260919.md)（真实 IP 切换后受管 `/32` 同步、排他端口清理和 SSH 重连闭环；用户已验收） |
