...
cp "$PROJECT_ROOT/scripts/tunnelpad-remote-forward-cleanup" "$APP_BUNDLE/Contents/Resources/tunnelpad-remote-forward-cleanup"
chmod +x "$APP_BUNDLE/Contents/Resources/tunnelpad-remote-forward-cleanup"
cp "$PROJECT_ROOT/scripts/tunnelpad-remote-forward-helper.py" "$APP_BUNDLE/Contents/Resources/tunnelpad-remote-forward-helper.py"
chmod +x "$APP_BUNDLE/Contents/Resources/tunnelpad-remote-forward-helper.py"
